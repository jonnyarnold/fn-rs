...
const OPCODE_AND: u8 = 0x10;
const OPCODE_OR: u8 = 0x11;
...
impl Display for Instruction {
    fn fmt(&self, f: &mut Formatter<'_>) -> Result {
        match self {
            Instruction::And(r1, r2, r3) => write!(f, "AND {} {} -> {}", r1, r2, r3),
            Instruction::Or(r1, r2, r3) => write!(f, "OR {} {} -> {}", r1, r2, r3),
            Instruction::Return(r1) => write!(f, "RETURN {}", r1),
        }
    }
}
